...
describe OAuth2::Provider::Models::Mongoid::Client do
  describe "any instance" do
    subject do
      OAuth2::Provider::Models::Mongoid::Client.new
    end
    ...
    it "is invalid if oauth_identifier not unique" do
      duplicate = OAuth2::Provider::Models::Mongoid::Client.create!
  ...
  describe "a new instance" do
    ...
    it "is assigned a randomly generated oauth identifier" do
      ...
      OAuth2::Provider::Models::Mongoid::Client.new.oauth_identifier.should_not be_nil
      subject.oauth_identifier.should_not == OAuth2::Provider::Models::Mongoid::Client.new.oauth_identifier
    end

    it "is assigned a randomly generated oauth secret" do
      subject.oauth_secret.should_not be_nil
      OAuth2::Provider::Models::Mongoid::Client.new.oauth_secret.should_not be_nil
      subject.oauth_secret.should_not == OAuth2::Provider::Models::Mongoid::Client.new.oauth_secret
    end
  ...
  describe "a saved instance" do
    subject do
      OAuth2::Provider::Models::Mongoid::Client.create!
    end
    ...
    it "is findable by calling from_param with its oauth_identifier" do
      subject.should == OAuth2::Provider::Models::Mongoid::Client.from_param(subject.oauth_identifier)
    end
  end
end